...
if ((categoria.equals("Panino")) || categoria.equals("Bibita"))
{
 products = pd.getByCategory(categoria);
} 

else{

int price=Integer.parseInt(categoria);  
 products = pd.getByPrice(price);
				...
				<%} else {%>
					...
					<div class="card w-100" style="width: 18rem;">
						...
						<div class="card-body">
							...
							<div class="mt-3 d-flex justify-content-between">
								<a href="add-to-cart?id=<%= p.getId() %>" class="">Modifica</a>
